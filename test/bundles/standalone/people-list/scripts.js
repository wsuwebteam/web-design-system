...
var PeopleList = function PeopleList(el) {
  ...
  function getPersonHTML(person) {
    if (profileLink && person.bio) {
      person.name = "<a href=\"".concat(profileLink, "\">").concat(person.name, "</a>");
    }
